      ...
      <header>
        ...
        <nav>
          <ul>
            ...
            <li><a href="blog/" class='link'>News <span class="external-link-icon glyphicon glyphicon-new-window"></span></a></li>
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="item active">
              <img src="images/enactus-group_1.JPG">
            </div>
            <div class="item">
              <img src="images/enactus-group_2.JPG">
              <div class="carousel-caption">
                <h3></h3>
              </div>
            </div>
            <div class="item">
              <img src="images/enactus-group_3.JPG">
              <div class="carousel-caption">
                <h3></h3>
              </div>
            </div>
